                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          getItemRow("3", "T-shirts (man)", "\Tk30.00"),
                          getItemRow("2", "T-shirts (man)", "\Tk40.00"),
                          getItemRow("4", "Pants (man)", "\Tk80.00"),
                          getItemRow("1", "Jeans (man)", "\Tk20.00"),
                          SizedBox(
                            height: 30.0,
                          ),
                          Text(
                          ...
                          getItemRow("3", "T-shirt (woman)", "\Tk30.00"),
                          Divider(),
                          getSubtotalRow("Subtotal", "\Tk200.00"),
                          getSubtotalRow("Delivery", "\Tk225.00"),
                          SizedBox(
                            height: 10.0,
                          ),
                          getTotalRow("Total", "\Tk225.00"),
                        ],
                      ),
                    ),
