...
class LatestOrders extends StatelessWidget {
  final List<Order> orders = [
    Order(
      id: 507,
      deliveryAddress: "Mirpur 12",
      arrivalDate: DateTime(2021, 11, 20),
      placedDate: DateTime(2021, 11, 20),
      status: OrderStatus.DELIVERING,
    ),
    Order(
      id: 536,
      deliveryAddress: "Uttora 13",
      arrivalDate: DateTime(2021, 11, 21),
      placedDate: DateTime(2021, 11, 19),
